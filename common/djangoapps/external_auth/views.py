...
from student.models import UserProfile, Registration, UserProfile
...
@csrf_exempt
def cm_create_account(request, post_override=None):
    """
    ...
    for a in ['username', 'email', 'password', 'name']:
        if a not in post_vars:
            ...
            js['field'] = a
            return HttpResponse(json.dumps(js), status=401)
...
# try to eliminate the need for this function
