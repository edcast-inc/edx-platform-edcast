...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CmGradebookRecords.score'
        db.alter_column('cm_plugin_cmgradebookrecords', 'score', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'CmGradebookRecords.score'
        db.alter_column('cm_plugin_cmgradebookrecords', 'score', self.gf('django.db.models.fields.FloatField')(default=None))
