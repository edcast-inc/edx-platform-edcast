...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CmGradebookRecords.unit_name'
        db.alter_column('cm_plugin_cmgradebookrecords', 'unit_name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'CmGradebookRecords.unit_name'
        db.alter_column('cm_plugin_cmgradebookrecords', 'unit_name', self.gf('django.db.models.fields.CharField')(max_length=1000))
