...
def render_404(request):
    if 'application/json' in request.META.get('CONTENT_TYPE', 'application/json'):
        return HttpResponse(json.dumps({"error": "Page Not Found"}), content_type="application/json", status=404)
