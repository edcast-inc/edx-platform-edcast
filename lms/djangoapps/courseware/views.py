...
from cm_plugin.healthcheck import check_services
...
def index(request, course_id, chapter=None, section=None,
    ...
    try:
        ...
        if section is not None:
            ...
            context['edcast_data'] = {'section':
                              {'id': chapter, 'name': chapter_descriptor.display_name_with_default},
                          'subsection':
                              {'id': section, 'name': section_descriptor.display_name_with_default}
                        }
        else:
