...
if settings.LMS_TEST_ENV:
    ...
    urlpatterns += url(r'^$', 'static_template_view.views.render_404', name="root"),
...
if settings.COURSEWARE_ENABLED:
    ...
    if settings.LMS_TEST_ENV:
        urlpatterns += url(r'^courses/?$', 'branding.views.courses', name="courses"),
    else:
        urlpatterns += url(r'^courses/?$', 'static_template_view.views.render_404', name="courses"),
